...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field site on 'Template'
        db.create_table('warthog_template_site', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('template', models.ForeignKey(orm['warthog.template'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('warthog_template_site', ['template_id', 'site_id'])


    def backwards(self, orm):
        # Removing M2M table for field site on 'Template'
        db.delete_table('warthog_template_site')
