...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Resource', fields ['slug', 'parent']
        db.delete_unique('warthog_resource', ['slug', 'parent_id'])

        # Adding field 'Resource.site'
        db.add_column('warthog_resource', 'site',
        ...
        # Adding unique constraint on 'Resource', fields ['site', 'parent', 'slug']
        db.create_unique('warthog_resource', ['site_id', 'parent_id', 'slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Resource', fields ['site', 'parent', 'slug']
        db.delete_unique('warthog_resource', ['site_id', 'parent_id', 'slug'])
        ...
        db.create_table('warthog_resource_site', (
            ...
            ('resource', models.ForeignKey(orm['warthog.resource'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('warthog_resource_site', ['resource_id', 'site_id'])

        # Adding unique constraint on 'Resource', fields ['slug', 'parent']
        db.create_unique('warthog_resource', ['slug', 'parent_id'])
