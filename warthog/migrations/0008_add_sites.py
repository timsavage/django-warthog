...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field site on 'ResourceType'
        db.create_table('warthog_resourcetype_site', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('resourcetype', models.ForeignKey(orm['warthog.resourcetype'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('warthog_resourcetype_site', ['resourcetype_id', 'site_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field site on 'ResourceType'
        db.delete_table('warthog_resourcetype_site')
